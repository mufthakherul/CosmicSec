> ⚠️ **ARCHIVED** — This is a read-only historical snapshot (formerly `ROADMAP.md`).
> Active planning is in [`docs/ROADMAP_UNIFIED.md`](../../ROADMAP_UNIFIED.md). Do not edit this file.
