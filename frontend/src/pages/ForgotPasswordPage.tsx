            ...
            <section className="w-full max-w-md space-y-6 rounded-lg border border-slate-800 bg-slate-900 p-8 shadow-lg shadow-cyan-500/5">
                {sent ? (
                    ...
                    <div className="flex flex-col items-center gap-4 text-center">
                        ...
                        {error && (
                            <div className="w-full rounded-md border border-rose-700 bg-rose-900/30 px-4 py-3 text-sm text-rose-300" role="alert">
                                {error}
                            </div>
                        )}
                        ...
                        <form onSubmit={handleSubmit} className="space-y-4" noValidate>
                            <div className="space-y-1">
                                ...
                                <input
                                    ...
                                    disabled={isLoading}
                                />
                                {emailError && <p id="forgot-email-error" className="text-xs text-rose-400">{emailError}</p>}
                            </div>
