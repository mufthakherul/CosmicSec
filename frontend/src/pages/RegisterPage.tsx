      ...
      <section className="w-full max-w-md space-y-6 rounded-lg border border-slate-800 bg-slate-900 p-8 shadow-lg shadow-cyan-500/5">
        ...
        <form onSubmit={handleSubmit} className="space-y-4" noValidate>
          ...
          <div className="space-y-1">
            ...
            />
            {fieldErrors.name && (
              <p id="reg-name-error" className="text-xs text-rose-400">
                {fieldErrors.name}
              </p>
            )}
          </div>
          ...
          <div className="space-y-1">
            ...
            />
            {fieldErrors.email && (
              <p id="reg-email-error" className="text-xs text-rose-400">
                {fieldErrors.email}
              </p>
            )}
          </div>
          ...
          <div className="space-y-1">
            ...
            {fieldErrors.password && (
              <p id="reg-password-error" className="text-xs text-rose-400">
                {fieldErrors.password}
              </p>
            )}
          </div>
          ...
          <div className="space-y-1">
            ...
            {fieldErrors.confirmPassword && (
              <p id="reg-confirm-error" className="text-xs text-rose-400">
                {fieldErrors.confirmPassword}
              </p>
            )}
          </div>
