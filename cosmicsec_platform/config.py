...
class PlatformConfig:
    ...
    def __new__(cls):
        ...
        if cls._instance is None:
            cls._instance = super(PlatformConfig, cls).__new__(cls)
    ...
    def _setup_paths(self):
        ...
        if self._os_type == OSType.WINDOWS:
            self.app_data_dir = Path(os.getenv("APPDATA", home_dir / "AppData" / "Roaming")) / "CosmicSec"
            self.logs_dir = self.app_data_dir / "logs"
            self.cache_dir = Path(os.getenv("LOCALAPPDATA", home_dir / "AppData" / "Local")) / "CosmicSec" / "cache"
    ...
    def is_docker(self) -> bool:
        ...
        return self._deployment_mode in (
            DeploymentMode.DOCKER,
            DeploymentMode.DOCKER_COMPOSE
        )
    ...
    def __repr__(self) -> str:
        ...
        return (
            f"PlatformConfig(os={self._os_type.value}, "
            f"deployment={self._deployment_mode.value})"
        )
